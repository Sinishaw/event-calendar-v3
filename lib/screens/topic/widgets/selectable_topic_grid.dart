...
import 'package:event_calendar_v2/screens/topic/widgets/topic_grid_item.dart';
import 'package:event_calendar_v2/shared/enums.dart';
import 'package:flutter/material.dart';
import 'package:flutter_staggered_animations/flutter_staggered_animations.dart';

class SelectableTopicGrid extends StatefulWidget {
  const SelectableTopicGrid({super.key, this.callBack});
  final Function? callBack;
  @override
  State<SelectableTopicGrid> createState() => _SelectableTopicGridState();
}

class _SelectableTopicGridState extends State<SelectableTopicGrid> {
        ...
        return InkWell(
          ...
          child: AnimationConfiguration.staggeredGrid(
              ...
              child: FlipAnimation(
                  flipAxis: FlipAxis.y,
                  child: TopicGridItem(
                      iconData: subscriptionTopic.container,
                      isSelected: _selectedTopicsList.contains(subscriptionTopic)))),
        );
      }).toList(),
    );
    return Scaffold(
